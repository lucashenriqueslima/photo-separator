<div>
    <h2 class="text-4xl font-extrabold dark:text-white"> {{ $collection->title }} </h2>
    <p class="my-4 text-lg text-gray-500"> {{ $collection->description }} </p>
    ...
    <div x-data="{ open: false }">
        ...
        @teleport('body')
        <div x-show="open" id="staticModal" class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
